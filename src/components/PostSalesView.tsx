  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex justify-between items-end">
        <div>
          <h2 className="text-2xl font-bold text-[var(--text)]">Pós-Venda & Customer Success</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-[var(--panel)] border border-[var(--border)] rounded-xl p-6 shadow-sm">
          ...
          <p className="text-xs text-[var(--muted)] font-bold mb-6">Evolução mensal dos indicadores de saúde</p>
        ...
        <div className="bg-[var(--panel)] border border-[var(--border)] rounded-xl p-6 shadow-sm">
          ...
          <p className="text-xs text-[var(--muted)] font-bold mb-6">Valor vitalício por mês de entrada</p>
          <div className="h-80 w-full">
            <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1 space-y-4">
          ...
          {SUPPORT_METRICS.map((metric, idx) => (
            <div key={idx} className="bg-[var(--panel)] border border-[var(--border)] rounded-xl p-5 shadow-sm flex items-center gap-4">
              ...
              <div className="flex-1">
                <div className="text-xs font-bold text-[var(--muted)] uppercase tracking-wider">{metric.label}</div>
                <div className="flex items-end justify-between">
                  <div className="text-xl font-bold text-[var(--text)]">{metric.value}</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {POST_SALES_SUMMARY.map((item, idx) => (
          <div key={idx} className="bg-[var(--panel)] border border-[var(--border)] rounded-xl p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h4 className="font-bold text-[var(--text)]">{item.label}</h4>
            </div>
            <div className="text-2xl font-bold text-[var(--text)] mb-1">{item.value}</div>
