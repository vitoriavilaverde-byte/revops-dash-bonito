// src/App.tsx  (DASH BONITO - completo e ajustado para Strategy por TENANT)
...
const App = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case "dashboard":
        return <DashboardView apiBase={API_BASE} tenant={selectedTenant} />;

      // ✅ Framework agora acompanha metas por tenant selecionado
      case "framework":
        return (
          <FrameworkView
      ...
      case "leads":
        return <LeadsView apiBase={API_BASE} tenant={selectedTenant} />;

      case "vendas":
        return <SalesView apiBase={API_BASE} tenant={selectedTenant} />;
      ...
      // ✅ Gerenciar Clientes (kickoff -> publicar -> manda pro framework do MESMO tenant)
      case "clientes":
        return (
          <ClientsView
            tenantId={selectedTenant.id}
      ...
      // Feedback continua existindo como visão do usuário (fora do admin “conceitual”)
      case "feedback":
        return <FeedbackView />;
        ...
        <div className="flex-1 overflow-y-auto px-3 py-2 space-y-6">
          <div>
            ...
            <nav className="space-y-0.5">
              ...
              <SidebarItem
                ...
                onClick={() => setActiveTab("pos-vendas")}
              />
              <SidebarItem
                icon={Target}
                label="Campanhas"
          ...
          <div>
            ...
            <nav className="space-y-0.5">
              ...
              />
              {/* feedback permanece como visão do usuário */}
              <SidebarItem
                icon={MessageSquare}
                label="Feedback"
